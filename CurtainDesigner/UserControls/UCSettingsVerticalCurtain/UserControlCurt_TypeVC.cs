...
{
    public partial class UserControlCurt_TypeVC : UserControl
    {
        private static string connect_str = CurtainDesigner.Classes.ConnectionString.conn;
        private SqlConnection connection;
        private List<Classes.TypeWithPrice> types;

        public UserControlCurt_TypeVC()
        {
            InitializeComponent();
        ...
        private void load_data()
        {
            ...
            SqlCommand command_loadclients = new SqlCommand("Select * From [VC_types];", connection);
        ...
        {
            AddForms.VCAddForm.VCTypeAddForm newType = new AddForms.VCAddForm.VCTypeAddForm();
        ...
        private void bunifuCustomDataGridTypesDataBase_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 3)
            {
                AddForms.VCAddForm.VCTypeAddForm editType = new AddForms.VCAddForm.VCTypeAddForm(
