...
{
    public partial class UserControlCurt_AdditionalEquipmentVC : UserControl
    {
        ...
        public UserControlCurt_AdditionalEquipmentVC()
        {
            InitializeComponent();
        ...
        {
            AddForms.VCAddForm.VCAdditionalEquipmentAddForm additionalEquipmentAddForm = new AddForms.VCAddForm.VCAdditionalEquipmentAddForm();
        ...
        private void load_data()
        {
            ...
            SqlCommand command_loadEQUIPMENT = new SqlCommand("Select * From [VC_Additional_equipment];", connection);
