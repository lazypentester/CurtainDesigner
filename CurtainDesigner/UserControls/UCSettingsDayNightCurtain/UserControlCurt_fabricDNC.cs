...
{
    public partial class UserControlCurt_fabricDNC : UserControl
    {
        ...
        public UserControlCurt_fabricDNC()
        {
            InitializeComponent();
        ...
        {
            AddForms.DNCAddForm.DNCFabricFabricAddForm fabricAddForm = new AddForms.DNCAddForm.DNCFabricFabricAddForm();
        ...
        private void load_data()
        {
            ...
            SqlCommand command_loadclients = new SqlCommand("Select * From [DNC_Fabric];", connection);
        ...
        private string get_SubTypeName(string subtype_id)
        {
            ...
            SqlCommand command_loadsubtypename = new SqlCommand($"Select Subtype_name From [DNC_subtypes] Where Subtype_id = {subtype_id};", connectionForSubTypeName);
        ...
        private string get_CategoryName(string category_id)
        {
            ...
            SqlCommand command_loadcategoryname = new SqlCommand($"Select * From [DNC_category] Where Category_id = {category_id};", connectionForCategoryName);
        ...
        private void bunifuCustomDataGridFabricDataBase_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 11)
            {
                AddForms.DNCAddForm.DNCFabricFabricAddForm editFabric = new AddForms.DNCAddForm.DNCFabricFabricAddForm(
            ...
            else if (e.ColumnIndex == 12)
            {
                ...
                AddForms.DNCAddForm.DNCFabricFabricAddForm removeFabric = new AddForms.DNCAddForm.DNCFabricFabricAddForm(
                    bunifuCustomDataGridFabricDataBase.Rows[e.RowIndex].Cells["ColumnFabric_id"].Value.ToString(),
                    this
                    );
            }
