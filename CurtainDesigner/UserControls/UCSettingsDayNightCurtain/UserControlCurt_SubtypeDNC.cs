...
{
    public partial class UserControlCurt_SubtypeDNC : UserControl
    {
        ...
        public UserControlCurt_SubtypeDNC()
        {
            InitializeComponent();
        ...
        {
            AddForms.DNCAddForm.DNCFabricSubtypeAddForm subtypeAddForm = new AddForms.DNCAddForm.DNCFabricSubtypeAddForm();
        ...
        private void load_data()
        {
            ...
            SqlCommand command_loadclients = new SqlCommand("Select * From [DNC_subtypes];", connection);
        ...
        private void bunifuCustomDataGridSubTypesDataBase_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 4)
            {
                AddForms.DNCAddForm.DNCFabricSubtypeAddForm editSubtype = new AddForms.DNCAddForm.DNCFabricSubtypeAddForm(
            ...
            else if (e.ColumnIndex == 5)
            {
                ...
                AddForms.DNCAddForm.DNCFabricSubtypeAddForm removeSubtype = new AddForms.DNCAddForm.DNCFabricSubtypeAddForm(
                    bunifuCustomDataGridSubTypesDataBase.Rows[e.RowIndex].Cells["ColumnSubtype_id"].Value.ToString(),
                    this
                    );
            }
