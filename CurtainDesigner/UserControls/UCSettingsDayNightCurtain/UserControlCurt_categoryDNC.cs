...
{
    public partial class UserControlCurt_categoryDNC : UserControl
    {
        private static string connect_str = CurtainDesigner.Classes.ConnectionString.conn;
        private SqlConnection connection;
        List<Classes.Category> categories;

        public UserControlCurt_categoryDNC()
        {
            InitializeComponent();
        ...
        {
            AddForms.DNCAddForm.DNCFabricCategoryAddForm categoryAddForm = new AddForms.DNCAddForm.DNCFabricCategoryAddForm();
        ...
        private void load_data()
        {
            ...
            SqlCommand command_loadcategories = new SqlCommand("Select * From [DNC_category];", connection);
        ...
        private void bunifuCustomDataGridCategoriesDataBase_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 5)
            {
                AddForms.DNCAddForm.DNCFabricCategoryAddForm editCategory = new AddForms.DNCAddForm.DNCFabricCategoryAddForm(
