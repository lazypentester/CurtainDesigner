...
{
    public partial class UserControlCurt_AdditionalEquipmentRC : UserControl
    {
        ...
        public UserControlCurt_AdditionalEquipmentRC()
        {
            InitializeComponent();
        ...
        {
            AddForms.RCAddForm.RCAdditionalEquipmentAddForm additionalEquipmentAddForm = new AddForms.RCAddForm.RCAdditionalEquipmentAddForm();
        ...
        private void load_data()
        {
            ...
            SqlCommand command_loadEQUIPMENT = new SqlCommand("Select * From [RC_Additional_equipment];", connection);
