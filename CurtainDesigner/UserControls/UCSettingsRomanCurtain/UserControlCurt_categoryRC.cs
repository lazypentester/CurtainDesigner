...
{
    public partial class UserControlCurt_categoryRC : UserControl
    {
        private static string connect_str = CurtainDesigner.Classes.ConnectionString.conn;
        private SqlConnection connection;
        List<Classes.Category> categories;

        public UserControlCurt_categoryRC()
        {
            InitializeComponent();
        ...
        {
            AddForms.RCAddForm.RCPriceCategoryAddForm categoryAddForm = new AddForms.RCAddForm.RCPriceCategoryAddForm();
        ...
        private void load_data()
        {
            ...
            SqlCommand command_loadcategories = new SqlCommand("Select * From [RC_category];", connection);
        ...
        private void bunifuCustomDataGridCategoriesDataBase_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 3)
            {
                AddForms.RCAddForm.RCPriceCategoryAddForm editCategory = new AddForms.RCAddForm.RCPriceCategoryAddForm(
