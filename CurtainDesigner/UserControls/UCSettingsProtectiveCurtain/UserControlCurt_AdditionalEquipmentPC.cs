...
{
    public partial class UserControlCurt_AdditionalEquipmentPC : UserControl
    {
        ...
        public UserControlCurt_AdditionalEquipmentPC()
        {
            InitializeComponent();
        ...
        {
            AddForms.PCAddForm.PCAdditionalEquipmentAddForm additionalEquipmentAddForm = new AddForms.PCAddForm.PCAdditionalEquipmentAddForm();
        ...
        private void load_data()
        {
            ...
            SqlCommand command_loadEQUIPMENT = new SqlCommand("Select * From [PC_Additional_equipment];", connection);
