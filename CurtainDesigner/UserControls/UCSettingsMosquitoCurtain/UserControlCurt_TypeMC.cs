...
{
    public partial class UserControlCurt_TypeMC : UserControl
    {
        private static string connect_str = CurtainDesigner.Classes.ConnectionString.conn;
        private SqlConnection connection;
        private List<Classes.TypeWithPrice> types;

        public UserControlCurt_TypeMC()
        {
            InitializeComponent();
        ...
        private void load_data()
        {
            ...
            SqlCommand command_loadclients = new SqlCommand("Select * From [MC_types];", connection);
        ...
        {
            AddForms.MCAddForm.MCTypeAddForm newType = new AddForms.MCAddForm.MCTypeAddForm();
        ...
        private void bunifuCustomDataGridTypesDataBase_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 3)
            {
                AddForms.MCAddForm.MCTypeAddForm editType = new AddForms.MCAddForm.MCTypeAddForm(
