...
namespace CurtainDesigner.UserControls.UCSettingsMosquitoCurtain
{
    public partial class UserControlCurt_AdditionalEquipmentMC : UserControl
    {
        ...
        public UserControlCurt_AdditionalEquipmentMC()
        {
            InitializeComponent();
        ...
        {
            AddForms.MCAddForm.MCAdditionalEquipmentAddForm additionalEquipmentAddForm = new AddForms.MCAddForm.MCAdditionalEquipmentAddForm();
        ...
        private void load_data()
        {
            ...
            SqlCommand command_loadEQUIPMENT = new SqlCommand("Select * From [MC_Additional_equipment];", connection);
