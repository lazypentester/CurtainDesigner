...
{
    public partial class Edit_MC_OrderForm : Form
    {
        ...
        private Classes.MC2 curtain2;
        internal ToolTip tip;

        public Edit_MC_OrderForm()
        {
            InitializeComponent();
        }

        public Edit_MC_OrderForm(Classes.MC2 obj)
        {
            InitializeComponent();
        ...
        private async Task<double> getEquipmentPrice(string Equipment_id)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Select Price From [MC_Additional_equipment] Where Equipment_id = {Equipment_id};", connection);
        ...
        private void edit_img_id(string img)
        {
            ...
            random = num.Next();
            path = string.Join("", path, "draw_images\\mc\\print\\", random.ToString(), ".png");
        ...
        private async Task<bool> editCurtain()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Update Mosquito_curtains Set [Color_id] = {curtain2.system_color_id}, " +
        ...
        private async Task<bool> deleteCurtain(string _curtain_id)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Delete From [Mosquito_curtains] Where [Curtain_id] = {_curtain_id};", connection);
