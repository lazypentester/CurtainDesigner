...
{
    public partial class Edit_PC_OrderForm : Form
    {
        ...
        private Classes.PC2 curtain2;
        internal ToolTip tip;

        public Edit_PC_OrderForm()
        {
            InitializeComponent();
        }

        public Edit_PC_OrderForm(Classes.PC2 obj)
        {
            InitializeComponent();
        ...
        private void add_actions()
        {
            ...
            comboBoxCategory.SelectionChangeCommitted += (s, e) => { setToolTip((Control)s, comboBoxCategory.SelectedItem.ToString().Split(new char[] { '[', ',', ']' }, StringSplitOptions.None)[1]); };


            comboBoxCategory.SelectedValueChanged += (s, e) => { updatePrice(); };
        ...
        private async void updatePrice()
        {
            ...
            if (comboBoxEquipment.DataSource != null &&
        ...
        {
            curtain2.category_id = comboBoxCategory.SelectedValue.ToString();
        ...
        private async Task<bool> editCurtain()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Update Protective_curtains Set [Category_id] = {curtain2.category_id}," +
        ...
        internal async void removeCurtain(string id, Form form)
        {
            ...
            if (send)
            {
                ...
                (form as ReportOrderForms.FormPCTable).fillDataBase(); ;
            }
            else
        ...
        private async Task<bool> deleteCurtain(string _curtain_id)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Delete From [Protective_curtains] Where [Curtain_id] = {_curtain_id};", connection);
