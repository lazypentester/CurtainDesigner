...
namespace CurtainDesigner.ReportOrderForms.EditOrderForms
{
    public partial class Edit_FC_OrderForm : Form
    {
        ...
        private async Task<bool> editCurtain()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Update Fabric_curtains Set [Control_id] = {curtain2.side_id}, " +
        ...
        internal async void removeCurtain(string id, Form form)
        {
            ...
            if (send)
            {
                ...
                (form as ReportOrderForms.FormFabricCurtainTable).fillDataBase(); ;
            }
            else
        ...
        private async Task<bool> deleteCurtain(string _curtain_id)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Delete From [Fabric_curtains] Where [Curtain_id] = {_curtain_id};", connection);
