...
{
    public partial class Edit_DNC_OrderForm : Form
    {
        ...
        private Classes.DNC2 curtain2;
        internal ToolTip tip;

        public Edit_DNC_OrderForm()
        {
            InitializeComponent();
        }
        ...
        internal void load_info()
        {
            ...
            CurtainDesigner.Controllers.Classes.DNCControlerManager<Classes.DNC, List<Classes.DNC2>, OrderForms.FormDNCOrder, DataGridView> controler = new CurtainDesigner.Controllers.Classes.DNCControlerManager<Classes.DNC, List<Classes.DNC2>, OrderForms.FormDNCOrder, DataGridView>();
            ...
            Task t2 = Task.Run(() => controler.load_data_once_comboboxes(comboBoxFabric, $"Select * From DNC_Fabric Where Type_id = {curtain2.type_id} and Subtype_id = {curtain2.subtype_id};", "Name", "Fabric_id", Convert.ToInt32(curtain2.fabric_id)));
            ...
            Task t4 = Task.Run(() => controler.load_data_once_comboboxes(comboBoxEquipment, $"Select * From DNC_Additional_equipment Where Type_id = {curtain2.type_id};", "Equipment", "Equipment_id", Convert.ToInt32(curtain2.equipment_id)));
        ...
        private bool checkIsEmpty()
        {
            ...
            if (string.IsNullOrEmpty(bunifuMetroTextboxSubtype.Text))
            {
        ...
        private async Task<bool> editCurtain()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Update DayNight_curtains Set [Control_id] = {curtain2.side_id}, " +
        ...
        internal async void removeCurtain(string id, Form form)
        {
            ...
            if (send)
            {
                ...
                (form as ReportOrderForms.FormDNCTable).fillDataBase(); ;
            }
            else
        ...
        private async Task<bool> deleteCurtain(string _curtain_id)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Delete From [DayNight_curtains] Where [Curtain_id] = {_curtain_id};", connection);
