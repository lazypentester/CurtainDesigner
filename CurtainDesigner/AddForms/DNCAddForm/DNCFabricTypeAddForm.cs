...
{
    public partial class DNCFabricTypeAddForm : Form
    {
        ...
        public DNCFabricTypeAddForm()
        {
            InitializeComponent();
            tooltips();
        }

        public DNCFabricTypeAddForm(string id, string type_name)
        {
            InitializeComponent();
        ...
        public DNCFabricTypeAddForm(string id, UserControl control)
        {
            InitializeComponent();
        ...
        private async Task<bool> deleteType(string id)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Delete From [DNC_types] Where [DNC_types].[Type_id] = {id};", connection);
        ...
        private async Task<bool> sendNewType(string type_name)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Insert Into [DNC_types] Values (N'{type_name}');", connection);
        ...
        private async Task<bool> editType(string id, string type_name)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Update [DNC_types] Set [DNC_types].[Type_name] = N'{type_name}' Where [DNC_types].[Type_id] = {id};", connection);
