...
{
    public partial class FCFabricSubtypeAddForm : Form
    {
        ...
        public FCFabricSubtypeAddForm(string type_id, string subtype_id, string subtype_name)
        {
            InitializeComponent();
        ...
        public FCFabricSubtypeAddForm(string id, UserControl control)
        {
            InitializeComponent();
        ...
        private async Task<bool> sendNewSubtype(string _type_id, string subtype_name)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Insert Into [Fabric_curtains_subtypes] (Subtype_name, Type_id) Values (N'{subtype_name}', {_type_id});", connection);
        ...
        private async Task<bool> editSubtype(string _type_id, string subtype_name, string _subtype_id)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Update [Fabric_curtains_subtypes] Set [Subtype_name] = N'{subtype_name}' Where [Subtype_id] = {_subtype_id} and [Type_id] = {_type_id};", connection);
        ...
        private async Task<bool> deleteCategory(string _subtype_id)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Delete From [Fabric_curtains_subtypes] Where [Fabric_curtains_subtypes].[Subtype_id] = {_subtype_id};", connection);
