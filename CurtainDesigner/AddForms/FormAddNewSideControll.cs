...
{
    public partial class FormAddNewSideControll : Form
    {
        ...
        public FormAddNewSideControll()
        {
            InitializeComponent();
            tooltips();
        }

        public FormAddNewSideControll(string id, string side_name)
        {
            InitializeComponent();
        ...
        public FormAddNewSideControll(string id, UserControl control)
        {
            InitializeComponent();
        ...
        private async void removeSideControl(string id, UserControl control)
        {
            ...
            if (send)
            {
                ...
                (control as UserControls.UserControlSideControllDataBase).load_sides();
            }
            else
        ...
        private async Task<bool> sendNewControlSide(string name)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Insert Into [Control] Values (N'{name}');", connection);
        ...
        private async Task<bool> editControlSide(string id, string name)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Update [Control] Set [Control_side] = N'{name}' Where [Control_id] = {id};", connection);
        ...
        private async Task<bool> deleteControlSide(string id)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand($"Delete From [Control] Where [Control].[Control_id] = {id};", connection);
