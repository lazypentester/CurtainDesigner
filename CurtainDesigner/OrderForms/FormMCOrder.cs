...
{
    public partial class FormMCOrder : Form
    {
        ...
        public FormMCOrder()
        {
            ...
            LoadDataFromDb();
            comboBoxCurtainType.SelectionChangeCommitted += new EventHandler(loadTypePriceFromBD);
            ...
            labelTypePrice.TextChanged += (sender, e) => { updatePrice(); };
        ...
        private async void updatePrice()
        {
            ...
            if (comboBoxCurtainType.DataSource != null &&
                comboBoxCurtainType.SelectedValue != null &&
                labelTypePrice.Text != "0$" &&
